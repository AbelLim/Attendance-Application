...
public class LeaveManager
{
    ...
    public void postLeaveApplication(String userID, String certificateNumber, Uri file, String additionalComment, PostLeaveApplicationListener listener)
    {
        ...
        fm.uploadFile(file, key, new FileManager.OnFileUploadListener() {
            ...
            public void OnSuccess() {
                LeaveApplication application = new LeaveApplication(userID, key, certificateNumber, additionalComment);
                if(key!=null)
